...
public final class StateData {
    ...
    public static <T extends SavedData & NbtState> T getOrCreate(
        ...
        //? if >=1.21.11 {
        /*// SavedData is described by a codec here rather than a save/load pair, so the tag work the
        // state classes already do is wrapped as one: read with their loader, write with writeNbt.
